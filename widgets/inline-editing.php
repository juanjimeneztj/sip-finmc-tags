...
class Inline_Editing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inline Editing', 'sip-finmc-tags' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Title', 'sip-finmc-tags' ),
			]
		);
		...
		$this->add_control(
			'description',
			[
				'label' => __( 'Description', 'sip-finmc-tags' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Description', 'sip-finmc-tags' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'sip-finmc-tags' ),
			]
		);
